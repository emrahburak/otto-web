...
import ottoParkLogo from "@/assets/logo/otto-doga-park.png"
...
export const Footer = ({ footerItems }: FooterProps) => {
  return (
    <footer className=" w-full lg:pt-20 sm:pt-10  space-y-10 pt-10">
      ...
      <div className="grid lg:grid-cols-4 grid-cols-2 lg:max-w-5xl max-w-3xl mx-auto px-10 gap-5 lg:text-left text-center ">
